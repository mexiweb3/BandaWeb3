...
def main():
    ...
    txt_path = Path("website/inputs/hosted_spaces_2.txt")
    ...
    for i, line in enumerate(lines):
        if "Ended:" in line:
            ...
            # Find title by looking backwards
    ...
    print(f"Found {len(new_eps)} new 'Hosted Spaces' (Batch 2) to add.")
    ...
    if new_eps:
        ...
        print("Database updated with hosted spaces batch 2.")
