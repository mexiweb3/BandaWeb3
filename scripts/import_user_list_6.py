...
def main():
    ...
    txt_path = Path("website/inputs/hosted_spaces_5.txt")
    ...
    for i, line in enumerate(lines):
        if "Ended:" in line:
            ...
            for j in range(i-1, i-10, -1):
                ...
                # NEW Check: is it just a number? (Listener count might be in previous lines too if formatting is weird)
                # But typically title is text.
                title = candidate
                break
    ...
    print(f"Found {len(new_eps)} new 'Hosted Spaces' (Batch 5) to add.")
    ...
    if new_eps:
        ...
        print("Database updated with hosted spaces batch 5.")
