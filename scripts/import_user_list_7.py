...
def main():
    ...
    txt_path = Path("website/inputs/hosted_spaces_6.txt")
    ...
    for i, line in enumerate(lines):
        if "Ended:" in line:
            ...
            # Suffix if existing? 
            # Check if an episode with this DATE exists and is NOT the same title.
            # But simpler: if title changed, add it.
    ...
    print(f"Found {len(new_eps)} new 'Hosted Spaces' (Batch 6) to add.")
    ...
    if new_eps:
        ...
        print("Database updated with hosted spaces batch 6.")
